...
function playAudio(song) {
    if (currentAudio) {
        currentAudio.pause(); // Pause the currently playwing audio
    }
...
scenes.forEach(function(scene) {
  ...
  function createLinkHotspotElement(hotspot) {
    ...
    wrapper.addEventListener('click', function() {
        ...
        let s = findSceneDataById(hotspot.target).audioSrc;
        playAudio(s);
    });
  ...
  playAudio(scenes[0].data.audioSrc)
